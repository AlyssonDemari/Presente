...
document.getElementById('contadorHoras').textContent = `Passram-se ${horasTotais} horas desde o nosso dia.`;

document.getElementById('contadorMinutos').textContent = `Passram-se ${minutosTotais} Minutos desde o nosso dia.`;
